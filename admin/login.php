...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Prepare and bind
    $stmt = $conn->prepare("SELECT password FROM users_acc WHERE username = ?");
...
<body>
    <div class="login-container">
        ...
        <div class="footer">
            ...
            <input type="button" value="Create new account" class="create-account" onclick="window.location.href='create_account.php'" style="margin-top: 20px;"> <!-- Updated button -->
        </div>
    </div>
</body>
</html>